...
export const menusResp = {
    planos: `📦 *Nossos Planos IPTV:*\n\n💰 *Plano Básico* - R$XX/mês\n📺 *Plano Premium* - R$XX/mês\n🔥 *Plano Ultra HD* - R$XX/mês\n\nDigite *.pagamento* para ver as formas de pagamento.`,
    testeG: `🎥 *Teste Grátis!*\n\nPara solicitar um teste grátis, envie a mensagem com:\n\n📌 Seu nome completo\n📌 Seu e-mail\n📌 Seu dispositivo (Smart TV, Celular, etc.)\n\nNosso suporte entrará em contato!`,
